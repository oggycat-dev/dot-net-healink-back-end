        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxContentQuota = table.Column<int>(type: "integer", nullable: false, defaultValue: 50),
                    AutoPublish = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CreatorSettings", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatorSettingsId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Contents_CreatorSettings_CreatorSettingsId",
                        column: x => x.CreatorSettingsId,
                        principalTable: "CreatorSettings",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreatorSettings_CreatorId",
                table: "CreatorSettings",
                column: "CreatorId",
                unique: true);
